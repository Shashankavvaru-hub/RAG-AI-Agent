...
const ChatPage = () => {
  ...
  const [userInfo, setUserInfo] = useState({ name: "Shashank Avvaru" });
          ...
          <div className="modal-body help-modal-content">
            ...
            <div className="about-section mt-4">
              ...
              <div className="version-info">
                <h5>Developed by</h5>
                <p><a href="https://www.linkedin.com/in/shashank-avvaru-491791326/" target="_blank" rel="noreferrer">Shashank Avvaru</a></p>
                <h5>Version</h5>
                <p>v1.0.0</p>
                <p><small>Licensed under <a href="https://github.com/Shashankavvaru-hub/RAG-AI-Agent/blob/main/LICENSE" target="_blank" rel="noreferrer">MIT</a></small></p>
              </div>
            </div>
          </div>
              ...
              <div className="developer-section">
                <div className="developer-info">
                  <div className="developer-bio">
                    <p><strong>Shashank Avvaru</strong> – Software Engineer</p>
                    <p>Feel free to reach out for collaborations, questions, or new projects!</p>
                    <p>Email: <a href="mailto:alvshashank@gmail.com">alvshashank@gmail.com</a></p>
                  </div>
                  <div className="social-icons-container">
                    <h6 className="social-title">Connect with me</h6>
                    <div className="social-icons">
                      <a href="https://www.linkedin.com/in/shashank-avvaru-491791326/" target="_blank" rel="noreferrer" className="social-link">
                        <BsLinkedin size={24} title="LinkedIn" />
                      </a>
                      <a href="https://github.com/Shashankavvaru-hub/" target="_blank" rel="noreferrer" className="social-link">
